            ...
            <div className="col-12 col-md-10 col-lg-6 offset-md-1 offset-lg-0">
              ...
              {checkout && (
                <form onChange={this.handleChangeForm} onSubmit={this.captureOrder}>
                  <p className="font-size-subheader font-weight-semibold mb-4">Cliente</p>
                  <div className="row">
                    <div className="col-12 col-sm-6 mb-3">
                      <label className="w-100">
                        <p className="mb-1 font-size-caption font-color-light">Primeiro nome*</p>
                        <input
                          required
                    ...
                    <div className="col-12 col-sm-6 mb-3">
                      <label className="w-100">
                        <p className="mb-1 font-size-caption font-color-light">Último nome*</p>
                        <input
                          required
                  ...
                  <div className="row">
                    <div className="col-12 col-sm-6 mb-3">
                      <label className="w-100">
                        <p className="mb-1 font-size-caption font-color-light">Telefone</p>
                        <input
                          name="customer[phone]"
                          autoComplete="tel"
